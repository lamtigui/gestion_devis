...
@section('content')
    <!-- page title -->
    <x-page-title title="Créer Facture" pagetitle="Pages" />
                        ...
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            <div class="xl:col-span-4">
                                ...
                                <input type="text" id="inputValue" required placeholder="REferance de facture"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('n_facture') }}" name="n_facture">
                                @error('n_facture')
                            ...
                            <div class="xl:col-span-4">
                                ...
                                <input type="date" required placeholder="date de facture"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('date_facture') }}" name="date_facture">
                                @error('date_facture')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div><!--end col-->
                            <div class="xl:col-span-4">
                                ...
                                <input type="text" required placeholder="alternative"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('alternative') }}" name="alternative">
                                @error('alternative')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div><!--end col-->
                        ...
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-4">
                                ...
                                <input type="text" required placeholder="Etablit Par"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('etableur_name') }}" name="etableur_name">
                                @error('etableur_name')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div><!--end col-->
                            ...
                            @if (isset($devi))
                                <div class="xl:col-span-12">
                                    <label for="type_service_validation"
                                        ...
                                        de services</label>
                                    <input type="text"
                                        value="{{ $devi->appointment->type_besoin }} -> {{ $devi->appointment->autre_type_besoin }}"
                                        disabled
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                </div>
                            @else
                                <div class="xl:col-span-6">
                                    ...
                                    <select required
                                        ...
                                        <option value="services"
                                            {{ old('type_service_validation') == 'services' ? 'selected' : '' }}>Services
                                        </option>
                                        <option value="marchandise"
                                            {{ old('type_service_validation') == 'marchandise' ? 'selected' : '' }}>
                                            Marchandise
                                        </option>
                                        <option value="service_et_marchandise"
                                            {{ old('type_service_validation') == 'service_et_marchandise' ? 'selected' : '' }}>
                                            Service et marchandise</option>
                                        <option value="autre"
                                            {{ old('type_service_validation') == 'autre' ? 'selected' : '' }}>Autre
                                        </option>
                                    </select>
   ...
   <br>
                                <div class="xl:col-span-6" id="autre_type_service_div" style="display: none">
                                    ...
                                    <input type="text"
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                        value="{{ old('autre_type_service') }}" name="autre_type_service"
                                        id="autre_type_service_input" placeholder="">
                        ...
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            <div class="xl:col-span-6">
                                ...
                                <input type="text"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('autre_type_service') }}" name="numero_livraison"
                                    placeholder="numero de livraison">
                            ...
                            <div class="xl:col-span-6">
                                ...
                                <input type="date"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('date_livraison') }}" name="autre_type_service" placeholder="">
                        ...
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            <div class="xl:col-span-3">
                                ...
                                <input type="text" id="prixht" oninput="CalculatTvaAndTtc()"
                                    @if (isset($devi)) disabled value="{{ $devi->prix_hors_taxe }}" @endif
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('mantant_ht') }}" name="mantant_ht" placeholder="montant HT">
                                @error('mantant_ht')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="xl:col-span-3">
                                ...
                                @if (isset($devi))
                                    <input type="number" value="{{ $devi->getNewTauxTvaAttribute() }}" disabled
                                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                ...
                                @else
                                    <select id="taux_tva" onchange="CalculatTvaAndTtc()" required
                                        ...
                                        <option value="20" {{ old('taux_tva') == '20' ? 'selected' : '' }}>
                                            20 %
                                        </option>
                                        <option value="0" {{ old('taux_tva') == '0' ? 'selected' : '' }}>
                                            0 %
                                        </option>
                                        <option value="autre" {{ old('taux_tva') == 'autre' ? 'selected' : '' }}>
                                            autre
                                        </option>
                                    </select>
                                @endif
                            ...
                            @endif
                            <div class="xl:col-span-3">
                                <label for="mantant_ht" class="inline-block mb-2 text-base font-medium">Remise </label>
                                <input type="number" id="remise" oninput="CalculatTvaAndTtc()"
                                    @if (isset($devi)) disabled value="{{ $devi->getRemiseFinalAttrinute() }}" @endif
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    value="{{ old('remise') }}" name="remise" placeholder="remise">
                                @error('remise')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            <div class="xl:col-span-3">
                                ...
                                <input type="text" id="mantant_tva"
                                    @if (isset($devi)) disabled value="{{ $devi->getMantantTvaAttribute() }}" @endif
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="number" id="mantantHTF"
                                    @if (isset($devi)) disabled value="{{ $devi->getMantantHTFinalAttrinute() }}" @endif
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <div class="xl:col-span-3">
                                ...
                                <input type="text" id="mantant_ttc"
                                    @if (isset($devi)) disabled value="{{ $devi->getMantantTtcAttribute() }}" @endif
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
