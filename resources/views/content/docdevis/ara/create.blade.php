        ...
        <div class="card devis-card">
            ...
            <div class=" flex justify-between">
                <div class="header-left">
                    ...
                    <div class="devis-cle">
                        <p>Référence : <span id="ref-span"></span><input type="text" name="reference" placeholder="__"
                                id="ref-input" /> </p>
                        <p>Date : {{\Carbon\Carbon::parse($devi->date)->isoFormat('DD/MM/YYYY')}}</p>
                        <p>N°client : <span id="nclient-span"></span> <input type="number" name="n_client"
                                placeholder="__" id="nclient-input" /></p>
                    </div>
                </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><textarea name="details" id="details-input" placeholder="Détails"></textarea>
                                <div id="details-div">
            ...
            <div class="devis-info">
                <div class="mode-conditions">
                    <div class="mode">
                        <h6>Mode de régelement: <span id="mode_span"></span> <input type="text" name="mode_paiement"
                                id="mode_input" placeholder="mode de paiment"></h6>
                    </div>
                    <div class="conditions">
                        <h6>Conditions de règlement: <span id="conditions_span"></span><input type="text"
                                name="conditions" id="conditions_input" placeholder="Conditions de règlement"> </h6>
