...
@endsection
@section('links')
<link rel="stylesheet" href="{{ URL::asset('build/css/nss_devis.css') }}">
    ...
    <div class="card devis-card">
      ...
      <div class=" flex justify-between">
        <div class="header-left">
          <img src="{{asset('build/images/NSS_logo.png') }}" alt="">
          <div class="info">
            <h6>RC: <span id="rc-span"></span> <input type="text" name="RC" id="rc-input" placeholder="__"
                value="{{$modele->RC}}"> </h6>
            <h6>IF: <span id="if-span"></span> <input type="number" name="IF" id="if-input" placeholder="__"
                value="{{$modele->IF}}"></h6>
            <h6>ICE: <span id="ice-span"></span> <input type="text" name="ICE" id="ice-input" placeholder="__"
                value="{{$modele->ICE}}"></h6>
          </div>
        </div>
        <div class="header-right ">
          ...
          <div class="num-ref">
            N° DE REF N°<input type="text" name="reference" placeholder="__" class="ref-input" id="ref-input"
              value="{{$modele->reference}}">
          ...
          <tbody>
            <tr>
              ...
              <td class="qte-td"><input type="number" id="qt" min="1" name="quantite" placeholder="_"
                  class="small-inputs" oninput="calculateTotalHT()" value="{{$modele->quantité}}"> </td>
              <td class="prix-unit-td"><input type="number" id="pu" oninput="calculateTotalHT()" class="small-inputs"
                  name="prix_unitaire" placeholder="_" value="{{$modele->prix_unitaire}}"></td>
              <td class="tva-td"><input type="number" id="tva" name="tva" placeholder="__" class="small-inputs"
                  oninput="calculateTTC()" value="{{$modele->tva}}" min="0">%</td>
              <td class="total-td" id="total-ht"></td>
            </tr>
          </tbody>
          <tfoot>
            <tr class="not-bordred">
              <td colspan="2" rowspan="5" class="not-bordred">
...
<script>
  ...
  download_btn.addEventListener('click', function () {
    ...
    InputToDiv('rc-input', 'rc-span')
    InputToDiv('if-input', 'if-span')
    InputToDiv('ice-input', 'ice-span')
    ...
    DivToInput('rc-input', 'rc-span')
    DivToInput('if-input', 'if-span')
    DivToInput('ice-input', 'ice-span')
    tds.forEach(item => {
