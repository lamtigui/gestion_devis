  ...
  <form method="POST" id="form">
          ...
          <tbody>
            <tr>
              <td class="description" id="description-td">
                <textarea name="details" id="details-input">{{$docdevi->details}}</textarea>
    ...
    <div class="buttons">
      ...
      <button class="btn button btn-success" type="button" onclick="docFormLink()"> <i data-lucide="save"
        ...
        Modification</button>
      <button data-bs-toggle="modal" data-bs-target="#modelenomModal" class="btn button btn-primary" type="button">
        <i data-lucide="file-check-2" width="15px"></i>Sauvegarder
        Comme Modèle</button>

    </div>
    <!-- MODAL -->
    <div class="modal fade" id="modelenomModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
