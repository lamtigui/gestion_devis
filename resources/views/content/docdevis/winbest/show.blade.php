        ...
        <div class="card devis-card">
                    ...
                    <div class="head-info">
                        ...
                        <div class="nom-societe">
                            ...
                            <input type="text" name="nom_client" placeholder="NOM DU CLIENT"
                                value="{{$docdevi->nom_client}}" class="nom-societe-input" id="nom-societe-input">
                        </div>
                    </div>
                    <div class="stars">
            ...
            <div class="prestation">
                ...
                <textarea type="text" name="titre" placeholder="TITRE DU DEVIS" class="prestation-input"
                    id="prestation-input"> {{$docdevi->titre}} </textarea>
            </div>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="4" class="prestation-nom">
                                ...
                                <textarea name="prestation" id="prestation-nom-input"
                                    placeholder="PRESTATION">{{$docdevi->prestation}} </textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="details" id="details-td">
                                ...
                                <textarea name="details" id="details"
                                    placeholder="Détails">{{$docdevi->details}}</textarea>
                            </td>
                        ...
                        <tr>
                            <td colspan="2" rowspan="9" class="politique" id="politique-td">
                                ...
                                <textarea name="politique" id="politique" placeholder="Politique de gestion des agents"
                                    value="{{$docdevi->politique}} ">{{$docdevi->politique}} </textarea>
                            </td>
                            <th class="total-ht">
                ...
                <div class="mode-pay">
                    <p> <span class="titre">MODE DE PAIEMENT : </span>
                        <textarea name="mode_paiement" id="mode-pay"
                            placeholder="Mode de paiement"> {{$docdevi->mode_paiement}} </textarea>
