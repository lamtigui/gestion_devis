    ...
    <div class="card devis-card">
      ...
      <div class=" flex justify-between">
        <div class="header-left">
          ...
          <div class="info">
            <h6>RC: <span id="rc-span"></span> <input type="text" name="RC" id="rc-input" placeholder="__"> </h6>
            <h6>IF: <span id="if-span"></span> <input type="number" name="IF" id="if-input" placeholder="__"></h6>
            <h6>ICE: <span id="ice-span"></span> <input type="text" name="ICE" id="ice-input" placeholder="__"></h6>
          </div>
        </div>
        <div class="header-right ">
          ...
          <div class="num-ref">
            DEVIS N° DE REF N/<input type="text" name="reference" placeholder="__" class="ref-input" id="ref-input">
