    ...
    <div class="tab-content">
        <div class="tab-pane" id="appointment">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div class="shrink-0">
                    <a href="{{ route('admin.appointment.create', ['client_id' => $client->id]) }}" type="button"
                        class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Ajouter
                        Rendez-vous</a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 2xl:grid-cols-4">
                                    ...
                                    <ul class="absolute z-50 hidden py-2 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem]"
                                        ...
                                        <li>
                                            <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear bg-white text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500"
                                                href="#!"><i data-lucide="eye" class="inline-block size-3 mr-1"></i>
                                                Overview</a>
                                        </li>
                                        <li>
                                            <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear bg-white text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="flex">
                            <div class="grow">
                                <img src="{{ URL::asset('build/images/brand/meta.png') }}" alt="" class="h-11">
                            </div>
                            <div class="shrink-0">
                                <div class="relative dropdown">
                                    <button
